...
export async function POST(request: Request) {
  try {
    ...
    const existingSessionId = typeof body.existingSessionId === "string" ? body.existingSessionId : undefined;
    const session = await startStudentSession(classCode, deviceType, existingSessionId);
